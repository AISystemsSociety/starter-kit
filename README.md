...
3. Download the growth plan deck template to `~/.claude/templates/`
...
| Template | What It Is |
|----------|-----------|
| **Growth Plan Deck** | 21-slide HTML presentation. Dark/light theme, animations, keyboard + swipe navigation, mobile responsive. Single file, zero dependencies. Fill in your data and present. |
...
```bash
mkdir my-deck && cp ~/.claude/templates/growth-plan-template.html my-deck/index.html
```
